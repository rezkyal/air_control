from settings.hand_settings import IS_POINTER_HAND_ON, MAX_TIP_POINTS, POINTER_HAND_BOTTOM_BOX_POSITION_PERCENTAGE, POINTER_HAND_BOX_COLOR, POINTER_HAND_BOX_SIZE_TO_SCREEN, POINTER_HAND_LEFT_BOX_POSITION_PERCENTAGE, POINTER_HAND_TIP_POINT_COLORS
from box import Box
...
class PointerHand(Hand):
    ...
    def __init__(self, camera_width, camera_height, monitor_width, monitor_height) -> None:
        ...
        self._pointer_box = Box(camera_width, camera_height, POINTER_HAND_BOX_COLOR, POINTER_HAND_LEFT_BOX_POSITION_PERCENTAGE, POINTER_HAND_BOTTOM_BOX_POSITION_PERCENTAGE, POINTER_HAND_BOX_SIZE_TO_SCREEN, self.POINTER_HAND_BOX_NAME)
    ...
    def move_cursor(self):
        if len(self._index_finger_tip_x) > 1:
            is_finger_in_box, x_in_box_percentage, y_in_box_percentage = self._pointer_box.finger_in_box(self._index_finger_position[0], self._index_finger_position[1])
